...
const char* ssid     = "HUAWEI-yuhan";         // XXXXXX -- 使用时请修改为当前你的 wifi ssid
const char* password = "yuhan123456";         // XXXXXX -- 使用时请修改为当前你的 wifi 密码
const char* host = "api.seniverse.com";
const char* APIKEY = "v2glz5hs081fpiu5";        //API KEY
...
//    -- 如果堆栈的内存池太大，使用 DynamicJsonBuffer jsonBuffer 代替
  ...
  strcpy(userData->humi, root["results"][0]["now"]["humidity"]);
